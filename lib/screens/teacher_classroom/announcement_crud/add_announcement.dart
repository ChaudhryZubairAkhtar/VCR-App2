...
import 'package:online_classroom/models/classrooms.dart';
import 'package:online_classroom/models/attachments.dart';
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      decoration: InputDecoration(labelText: "Title", border: OutlineInputBorder( borderRadius: BorderRadius.circular(10.0))),
                    ...
                    DropdownButtonFormField(
                      decoration: InputDecoration(labelText: "Type", border: OutlineInputBorder( borderRadius: BorderRadius.circular(10.0),)),
                      value: type,
                      onChanged: (newValue) {
                        setState(() {
                    ...
                    if(type == 'Assignment') DateTimeField(
                      decoration: InputDecoration(labelText: "Due Date", border: OutlineInputBorder( borderRadius: BorderRadius.circular(10.0))),
